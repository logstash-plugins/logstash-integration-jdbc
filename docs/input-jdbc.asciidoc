...
This plugin does some modification to the supplied statement during normal operations.
As a result, semicolon (`;`) terminated statements can throw syntax errors. 
