...
If you provide more than one scheduling statement, then `schedule` takes precedence over `interval` which takes precedence over `period`.
...
If you provide more than one scheduling statement, then <<plugins-{type}s-{plugin}-schedule>> takes precedence over `interval` which takes precedence over <<plugins-{type}s-{plugin}-period>>.
...
If you provide more than one scheduling statement, then <<plugins-{type}s-{plugin}-schedule>> takes precedence over <<plugins-{type}s-{plugin}-interval>> which takes precedence over `period`.
...
If you provide more than one scheduling statement, then `schedule` takes precedence over <<plugins-{type}s-{plugin}-interval>> which takes precedence over <<plugins-{type}s-{plugin}-period>>.
